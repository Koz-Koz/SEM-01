...
i = 0 
	journalist.each do |utilisateur|
	if (/[:digit:]/).match(utilisateur)
    i = i + 1	
  end
end 
puts i  
...
# QUESTION 6
puts journalist.sort_by {|utilisateur| utilisateur.downcase}
